# Laufey Albums App
Um mini projeto em React Native + Expo com o objetivo de praticar conceitos básicos e fundamentais no desenvolvimento mobile, navegação entre telas e organização de componentes. 
